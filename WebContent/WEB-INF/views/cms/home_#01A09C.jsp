...
<html>
  ...
  <body>
 	  	<!-- 头部信息 --> 
		<div data-options="region:'north',border:false" style="height:36px;line-height:34px;background:#01A09C;padding:0px;color:#FFF">
		...
		<!-- ***左边菜单导航*** -->
		<div id="west" data-options="region:'west',border:true,split:false,collapsible:true,collapsed:true,title:'导航菜单',iconCls:'icon_text_list_bullets'" style="width:180px;">
		...
		<!-- ***页尾*** -->
		<div id="south" data-options="region:'south',border:false" style="height:20px;background:#01A09C;padding:0px;color:#FFF">
			<span style=" float:left;display:block;">当前用户:${user.realname }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;所属科室:${user.deptname }</span>
			<span style=" float:right;display:block;">版本v1.0</span>
		</div>   
