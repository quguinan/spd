...
<body >
	...
	<table class="easyui-datagrid" style="width:400px;height:250px"  id="dg_stock" 
        data-options="
        		url:'${pageContext.request.contextPath}/cms/common/goodsStockSelectSum/datagrid?storeid='+${storeid },
        		fitColumns:true,
        		singleSelect:true,
        		toolbar:'#tb',
        		fit:true,
    ...
    <thead>   
        <tr>       
            ...
            <th data-options="field:'goodsname',width:120">名称</th>   
            <th data-options="field:'customname',width:120">别名</th>   
	...
	<script type="text/javascript">  
			function queryStock(){
				var url='${pageContext.request.contextPath}/cms/common/goodsStockSelectSum/datagrid?storeid="${storeid}"&'+$('#fm_stockSelect').serialize();
				$("#dg_stock").datagrid("reload",url)
			};
			function selectStock(){
				var row=$("#dg_stock").datagrid("getSelected");
				if(row){
					getStockGoodsid(row.storeid,row.goodsid,row.goodsdtlid);
