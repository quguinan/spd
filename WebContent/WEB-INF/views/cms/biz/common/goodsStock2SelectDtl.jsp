...
<body >
	...
	<table class="easyui-datagrid" style="width:400px;height:250px"  id="dg_stock" 
        data-options="
        		url:'${pageContext.request.contextPath}/cms/common/goodsStock2SelectDtl/datagrid?deptid=${deptid }',
        		fitColumns:true,
        		singleSelect:true,
        		toolbar:'#tb',
        		fit:true,
    ...
    <thead>   
        <tr>    
            <th data-options="field:'lotid'">批次</th>      
	...
	<script type="text/javascript">  
			function queryStock(){
				var url='${pageContext.request.contextPath}/cms/common/goodsStock2SelectDtl/datagrid?deptid=${deptid}&'+$('#fm_stockSelect').serialize();
				$("#dg_stock").datagrid("reload",url)
			};
			function selectStock(){
				var row=$("#dg_stock").datagrid("getSelected");
				if(row){
					getStock2Goodsid(row.stockid,row.lotid,row.deptid,row.goodsid,row.goodsdtlid);
