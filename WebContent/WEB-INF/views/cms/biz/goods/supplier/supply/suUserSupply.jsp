...
<title>平台供应商用户维护</title>
<jsp:include page="../../../../../inc/injs.jsp" />
<script type="text/javascript">
	$(function() {
		$("#dg").datagrid({
			url:WEB_ROOT+'/cms/biz/supply/userSupply/gridDataUser',   
		    columns:[[
						...
						{field:'supplyid', title:'供应商',align:'center' ,width:200,
							editor : {
								type : 'combobox',
								options : {
									url : WEB_ROOT+'/cms/biz/supply/supply/findAlljson',
									valueField: "supplyid",
						...
						{field:'supplyname', title:'供应商名称',align:'center',hidden:true ,width:200}, 
	...
	//查询
	function refresh(){
		$('#dg').datagrid('reload',WEB_ROOT+'/cms/biz/supply/userSupply/gridDataUser');
	};
	//保存
	function saveUser() {
		endEdit($("#dg"));
		if ($("#dg").datagrid('getChanges').length) {
			...
			$.post(WEB_ROOT+'/cms/biz/supply/userSupply/saveUser', {
...
<body>
	...
	<script type="text/javascript">
		...
		function getSysUser(userid,username,realname){
			var row=$('#dg').datagrid('appendRow',{ userid: userid, realname:realname,username:username,usertype:'2' });//供应商用户
			saveUser();
			/* endEdit($("#dg"));
	    	edit($("#dg")); */
		}
