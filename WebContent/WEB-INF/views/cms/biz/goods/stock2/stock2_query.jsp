   ...
   <base href="<%=basePath%>">
	...
	<script type="text/javascript"> 
		$(function(){ 
			...
			$('#dg1').datagrid({
	       		url:WEB_ROOT+'/cms/goods/stock2/stock2_query/gridData1',
			    columns:[[
					//{field:'stockid',title:'',align:'center' ,hidden:true},    
					{field:'deptid',title:'',align:'center'  ,hidden:true},
			    ...
			    onDblClickRow : function(index, row){
			    	$('#dlg_io').dialog('open');
			    	$('#dg_io').datagrid("load",WEB_ROOT+'/cms/goods/stock2/stock2_query/gridDataIOByGoodsid?goodsid='+row.goodsid+"&goodsdtlid="+row.goodsdtlid);
			    }
			});  
			
			$('#dg2').datagrid({
	       		url:WEB_ROOT+'/cms/goods/stock2/stock2_query/gridData2',
			    columns:[[
			        {field:'stockid',title:'',align:'center' ,hidden:true},    
			        {field:'deptid',title:'',align:'center'  ,hidden:true},
			        {field:'deptname',title:'科室',align:'center' },
			    ...
			    onDblClickRow : function(index, row){
			    	$('#dlg_io').dialog('open');
			    	$('#dg_io').datagrid("load",WEB_ROOT+'/cms/goods/stock2/stock2_query/gridDataIOBylotid?lotid='+row.lotid);
			    }
			});  
		...
		function query1(){
			$('#dg1').datagrid("load",WEB_ROOT+'/cms/goods/stock2/stock2_query/gridData1');
		};
		function query2(){
			$('#dg2').datagrid("load",WEB_ROOT+'/cms/goods/stock2/stock2_query/gridData2');
		};
	</script>
</head>
<body>
